...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		ServiceRegistryRequestDTO forceTempServiceRequest = createServiceRegistryRequest(LineCommonConstants.POST_ARM_SERVICE_DEFINITION,  LineCommonConstants.ARM_URI, HttpMethod.POST);		
	...
	public void customDestroy() {
		//Unregister service
		arrowheadService.unregisterServiceFromServiceRegistry(LineCommonConstants.POST_ARM_SERVICE_DEFINITION,  LineCommonConstants.ARM_URI);
