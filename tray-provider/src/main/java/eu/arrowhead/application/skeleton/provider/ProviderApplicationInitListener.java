...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		ServiceRegistryRequestDTO postTrayServiceRequest = createServiceRegistryRequest(LineCommonConstants.POST_TRAY_SERVICE_DEFINITION, LineCommonConstants.TRAY_URI, HttpMethod.POST);		
		arrowheadService.forceRegisterServiceToServiceRegistry(postTrayServiceRequest);
		
		ServiceRegistryRequestDTO getTrayServiceRequest = createServiceRegistryRequest(LineCommonConstants.GET_TRAY_SERVICE_DEFINITION, LineCommonConstants.TRAY_URI, HttpMethod.GET);
		arrowheadService.forceRegisterServiceToServiceRegistry(getTrayServiceRequest);
	}
	...
	public void customDestroy() {
		//Unregister service
		arrowheadService.unregisterServiceFromServiceRegistry(LineCommonConstants.POST_TRAY_SERVICE_DEFINITION, LineCommonConstants.TRAY_URI);
		arrowheadService.unregisterServiceFromServiceRegistry(LineCommonConstants.GET_TRAY_SERVICE_DEFINITION, LineCommonConstants.TRAY_URI);
	}
